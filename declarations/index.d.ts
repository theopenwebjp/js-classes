...
export namespace DrawableCanvas {
    export { str as message };
}
export namespace Drawer { }
export namespace FormatConverter { }
export namespace ImageEditor { }
export namespace ImagePrompter { }
export namespace Log { }
export const TextManager: any;
export { CanvasChangeChecker, CanvasHelper, CanvasManager, CanvasRenderer, DomHelper, FormManager, FunctionWrapper, InputCopier, I18n, PageManager, PersistentStateManager, Sharer, StandardUnitHelper, StreamManager, StreamHelper, TrackHelper, TrackManager };
