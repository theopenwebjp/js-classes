...
export default class I18n {
  /**
   * @param {import("./types/ts").TextManagerSettings} settings 
   */
  constructor(settings) {
      
    /**
     * @type {import("./types/ts").TextManagerSettings}
     */
  ...
  /**
   * @param {Partial<import("./types/ts").TextManagerSettings>} options
   * @return {import("./types/ts").TextManagerSettings}
   */
  Settings(options = {}) {
