...
export default class InputCopier {
  constructor() {
    /**
     * @type {import("./types/ts").CopierElements}
     */
    this.elements = {
      main: null,
      pages: null
    ...
    /**
     * @type {import("./types/ts").CopierEvents}
     */
    ...
    /**
     * @type {{ copy: any }} // TODO: What is this?
     */
    this.state = {
      copy: null
    }
  ...
  Page () {
    ...
    /**
     * @type {import("./types/ts").PageElements}
     */
    page.elements = {
      main: null,
      list: null,
    ...
    /**
     * @type {import("./types/ts").PageEvents}
     */
    page.events = {
    ...
    /**
     * @type {import("./types/ts").PageState}
     */
    page.state = {
      receiver: false,
      sender: false
    ...
    /**
     * @param {import("./types/ts").RowOptions} [obj]
     * @return {HTMLElement}
     */
    ...
    /**
     * Helper for multiple
     * @param {import("./types/ts").RowOptions[]} arr
     */
    page.formatRows = (arr) => {
      const rows = []
